...
@canvas.explore(position=(1170, -2303), size=(420, 260), code_height=0, viz={'measure': {'columns': {'x': 't_abs_ms', 'y': 'value'}, 'range': {'from': 1786497810920.939, 'mode': 'absolute', 'to': 1786499168284.4568}, 'signals': [], 'table': 'can_signals_v13', 'windows': [{'axes': [], 'cursor': {'scope': 'shared'}, 'height': 176, 'hidden': [], 'id': 'w1_1', 'signals': [], 'yMode': 'shared'}, {'axes': [], 'cursor': {'scope': 'shared'}, 'height': 176, 'hidden': [], 'id': 'w2_2', 'signals': [], 'yMode': 'shared'}]}})
def explore_1():
    pass
