...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      {/* The sr-only header must live INSIDE DialogContent (FR-DM-091): as a
          sibling it rendered into the page, not the dialog popup, so the
          heading sat in the topbar's reading order permanently and the open
          dialog could not be labeled by it. */}
      <DialogContent
        className={cn(
